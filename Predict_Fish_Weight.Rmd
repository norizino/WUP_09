...
The P-Value is 0.4027 it is a little smaller than the Perch P-Value, meaning that there is a litte different difference between using the model with all the data vs the model with only 2 variables.
...
The P-Value is 0.05648 it is a smaller size P-VAlue compared to Perch and Bream P-Value, meaning that there is a difference between using the model with all the data vs the model with only 2 variables.
